...
export const DetailPage = ({ product, relatedProducts = [], loading, error }) => {
  // 오류 상태면 오류 UI 표시
  if (error) {
    return PageLayout({
      children: /* html */ `
        ...
        <main class="max-w-md mx-auto px-4 py-4">
          ...
          <nav class="mb-4">
            <div class="flex items-center space-x-2 text-sm text-gray-600">
              <a href="${import.meta.env.BASE_URL}" data-link="" class="hover:text-blue-600 transition-colors">홈</a>
              ...
              <button class="breadcrumb-link hover:text-blue-600 transition-colors" data-category2="${product.category2}" data-parent-category1="${product.category1}">
                ${product.category2}
              </button>
            </div>
          </nav>
              ...
              <div class="flex items-center justify-between mb-4">
                ...
                <div class="flex items-center">
                  <button 
                    ...
                    class="detail-quantity-decrease-btn w-8 h-8 flex items-center justify-center border border-gray-300 
                  ...
                  <input 
                    ...
                    class="detail-quantity-input w-16 h-8 text-center text-sm border-t border-b border-gray-300 
                    focus:ring-1 focus:ring-blue-500 focus:border-blue-500"
                  >
                  <button 
                    id="quantity-increase" 
                    data-product-id="${product.productId}"
                    class="detail-quantity-increase-btn w-8 h-8 flex items-center justify-center border border-gray-300 
