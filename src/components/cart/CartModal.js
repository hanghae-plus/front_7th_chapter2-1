...
const CartItem = ({ item }) => {
  const { productId, title, image, lprice, quantity } = item;
  const totalPrice = parseInt(lprice) * quantity;

  return /*HTML*/ `   <div class="flex items-center py-3 border-b border-gray-100 cart-item" data-product-id="${productId}">
            <!-- 선택 체크박스 -->
