...
const ProductDetail = createComponent({
  ...
  eventHandlers: {
    ...
    "add-to-cart": (props, getter, setter, event) => {
      ...
      appStore.addToCart(
        {
          id: props.productDetailResponse.productId,
          title: props.productDetailResponse.title,
          image: props.productDetailResponse.image,
          price: props.productDetailResponse.lprice,
          selected: false,
        },
        count,
      );
