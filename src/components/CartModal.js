 ...
 */
export default function CartModal({ cart = [], selectedCartIds = [] }) {
                    ...
                    ${selectedCartIds.length > 0
                      ? /* HTML */ `
                          <div class="flex justify-between items-center mb-3 text-sm">
                            <span class="text-gray-600">선택한 상품 (${selectedCartIds.length}개)</span>
                    ...
                    <div class="space-y-2">
                      ${selectedCartIds.length > 0
                        ? /* HTML */ `
                            ...
                            >
                              선택한 상품 삭제 (${selectedCartIds.length}개)
                            </button>
                          `
                        : ""}
