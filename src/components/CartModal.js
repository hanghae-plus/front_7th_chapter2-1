  ...
  return `
    ...
    >
      ...
      <div class="text-right ml-3">
        <p class="cart-item-price text-sm font-medium text-gray-900">${Number(Number(product.price) * Number(product.quantity)).toLocaleString()}원</p>
              ...
              : `<!-- 컨텐츠 -->
                  <div class="flex flex-col max-h-[calc(90vh-120px)]">
                    ...
                    <div class="flex-1 overflow-y-auto">
                      <div class="p-4 space-y-4">${products.map(CartItem).join("")}</div>
                    </div>
                  </div>
                  <!-- 하단 액션 -->
