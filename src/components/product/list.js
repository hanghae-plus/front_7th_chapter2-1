export function productList(props) {
  let isLast = props?.isLast || false;
  let list = props?.list || [];

  // let isLoading = false;
  // let skeleton = `<div class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden animate-pulse">
  ...
  <div>
    ...
    ${isLast ? `<div class="text-center py-4 text-sm text-gray-500">모든 상품을 확인했습니다</div>` : ""}
  </div>`;
}
